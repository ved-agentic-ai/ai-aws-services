...
Resources:
  ...
  PaymentProcessorFunction:
    ...
    Properties:
      ...
      Code:
        ZipFile: |
          import json, boto3, os, logging, base64, re, traceback
          ...
          def lambda_handler(event, context):
              ...
              try:
                  ...
                  if http_method == 'OPTIONS': return {'statusCode': 200, 'headers': headers, 'body': ''}
                  body_data = event
                          ...
                          for doc in expense_res.get('ExpenseDocuments', []):
                              for field in doc.get('SummaryFields', []):
                                  ...
                                  if 'VENDOR' in t or 'NAME' in t: extracted_vendor = v
                                      ...
                                      try:
                                          cn = re.sub(r'[^\d.]', '', v)
                                          if cn: extracted_total = float(cn)
                  ...
                  return {'statusCode': 500, 'headers': headers, 'body': json.dumps({'error': f"Lambda Execution Error: {str(top_err)}"})}
  HttpApiGateway:
    Type: AWS::ApiGatewayV2::Api
    Properties:
      Name: PaymentDocApi
