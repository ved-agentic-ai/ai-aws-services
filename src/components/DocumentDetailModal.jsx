...
import { 
  ...
  ShieldAlert, ShieldCheck, CheckCircle2, Code, Layers, FileCheck, Eye, Cpu, Scan, CheckSquare, 
      ...
      <div className="relative w-full max-w-6xl bg-[#0B0F19] border border-slate-800 rounded-2xl shadow-2xl overflow-hidden flex flex-col max-h-[92vh]">
        ...
        <div className="flex-1 grid grid-cols-1 lg:grid-cols-12 overflow-hidden">
          ...
          <div className="lg:col-span-5 bg-slate-950/90 p-5 border-r border-slate-800 flex flex-col justify-between overflow-y-auto">
            ...
            {/* Nordic Credit Riskklass & Bedrock GenAI Box */}
            <div className="mt-4 p-4 rounded-xl bg-slate-900 border border-amber-500/30 space-y-3">
              <div className="flex items-center justify-between">
                <span className="text-[11px] font-bold text-amber-400 uppercase font-mono tracking-wider flex items-center gap-1.5">
                  <ShieldCheck className="h-3.5 w-3.5" /> Nordic Credit Risk Engine (Sweden Framework)
                </span>
